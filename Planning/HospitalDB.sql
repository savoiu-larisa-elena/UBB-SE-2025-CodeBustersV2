...
--	THE DoctorName IS MISSING BUT IT EXISTS IN THE MODEL ???????????????
...
--	THE PatientName IS MISSING BUT IT EXISTS IN THE MODEL ???????????????
...
CREATE TABLE Shifts(
	...
	Date DATETIME NOT NULL,  --- should be DateTime
...
-------------------------------------
-- THERE SHOULD BE A RATING TABLE AS WELL
-------------------------------------
